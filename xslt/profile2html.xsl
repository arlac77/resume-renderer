...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:function name="pro:software">
        ...
        <pro:software>
            ...
            <pro:name><xsl:value-of select="($software/name,$name)[1]"/></pro:name>
                                    ...
                                    <section class="mb-4 col-break-avoid">
                                        <ul>
                                            ...
                                            <xsl:if test="pro:person/pro:telegram">
                                                <li class="mt-1.5 flex items-start justify-start text-m text-gray-700 leading-normal">
                                                    <span class="icon-parent flex items-center justify-center flex-shrink-0">
                                                        <svg class="w-4.5 h-4.5" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 512 512" width="24">
                                                            <g>
                                                    ...
                                                    <span class="ml-1.5">
                                                        <a><xsl:attribute name="href" select="concat('https://t.me/',pro:person/pro:telegram)"/><xsl:value-of select="pro:person/pro:telegram" /></a>
                                                    </span>
                                                </li>
                                            </xsl:if>
                                            <li class="mt-1.5 flex items-start justify-start text-m text-gray-700 leading-normal">
                                            ...
                                            <li class="mt-1.5 flex items-start justify-start text-m text-gray-700 leading-normal">
                                                ...
                                                <span class="ml-1.5">
                                                    <a><xsl:attribute name="href" select="concat('mailto:',pro:person/pro:email)"/><xsl:value-of select="pro:person/pro:email" /></a>
                                                </span>
                                            </li>
                                            <li class="mt-1.5 flex items-start justify-start text-m text-gray-700 leading-normal">
                                                <span class="icon-parent flex items-center justify-center flex-shrink-0">
